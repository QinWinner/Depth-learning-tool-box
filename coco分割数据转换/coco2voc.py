...
def coco2voc(image_path,anns_file, target_folder, n=None, compress=True):
    '''
    ...
    for i, img in enumerate(coco_imgs):
        ...
        name=image_details['file_name']
        image=Image.open(os.path.join(image_path,name))

        img=name.split(".")[0]
        image.save(images_path+"/"+str(img) + '.png')
...
if __name__ == "__main__":
    annotations_file = '/home/qinjian/Segmentation/地理遥感图像分割/aicrowd房屋分割竞赛/val/annotation.json'
    labels_target_folder = '/home/qinjian/Segmentation/地理遥感图像分割/aicrowd房屋分割竞赛/val_voc'
    image_path="/home/qinjian/Segmentation/地理遥感图像分割/aicrowd房屋分割竞赛/val/images"

    # Convert n=25 annotations
    coco2voc(image_path,annotations_file, labels_target_folder, compress=True)